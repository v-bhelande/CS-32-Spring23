...
int BadPlayer::chooseMove(const Board& b, Side s) const
{
    ...
    switch (s) {
        ...
        {
            // Iterate through holes and find one with least beans it
//            for (int i {NSIDES + b.holes()}; i <= NSIDES + 2*b.holes() - 1; i++)
//            {
//                cerr << "Beans at " << i << " = " << b.beans(s, i) << endl;
//                if (b.beans(s, i) != 0)
//                {
//                    cerr << "Returning first hole with nonzero beans: " << i << endl;
//                    return i;
//                    cerr << "After mapping for NORTH, what gets returned is: " << i-1-b.holes() << endl;
//                    return i-1-b.holes();
//                }
//            }
            for (int i {1}; i <= b.holes(); i++)
...
//                    return i-1-b.holes();
    ...
    cerr << "Something went wrong with your BadPlayer::chooseMove function, returning -1...\n";
    return -1;
}
...
int SmartPlayer::chooseMove(const Board& b, Side s) const
{
    ...
    cerr << "Something went wrong with your SmartPlayer::chooseMove function, returnin -1...\n";
    return -1;
}
