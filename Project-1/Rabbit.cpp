...
void Rabbit::move()
{
    // Do something in rabbit to call arena to call history to call record function when rabbit health = 1
    if (m_health == 1)
    ...
    // Do something in rabbit to call arena to call history to call record function when eabbit health = 1
    
    // You are free to make changes to the private members and to the implementations of the member functions
}
